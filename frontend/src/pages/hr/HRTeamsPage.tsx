...
import { useTeamsPage } from "../admin/hooks/useTeamsPage";

/**
 * HR-native Department Settings page (Part D: HR reaches team management
 * without routing through the admin panel). Reuses the same hook/components
 * as /admin/teams, but omits delete — TeamViewSet grants HR create/update
 * only, deleting a team stays admin/superuser-only.
 */
export const HRTeamsPage: React.FC = () => {
  ...
  return (
    <PageShell
      ...
      subtitle="Create and update teams. Deleting a team is admin-only."
      actions={
