...
/** shadcn/ui's Recharts wrapper (copied in, not npm-installed — MIT, no new
 * dependency). Gives every chart a shared CSS-variable color pipeline
 * (`--color-<key>` per series, driven by `ChartConfig`) plus themed
 * tooltip/legend so charts stop hand-rolling gradient/tooltip boilerplate. */
...
type TooltipContentProps = Omit<React.ComponentProps<"div">, "label"> & {
  active?: boolean;
