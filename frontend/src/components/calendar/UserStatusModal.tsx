...
export const UserStatusModal: React.FC<UserStatusModalProps> = ({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="pointer-events-auto max-h-[90vh] max-w-4xl overflow-hidden border border-border bg-popover p-0 text-popover-foreground shadow-2xl backdrop-blur-xl [&>button]:hidden">
