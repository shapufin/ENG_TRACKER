...
export const calendarEventTypeStyles: Record<CalendarEvent["type"], CalendarTone> = {
  vacation: {
    ...
    chip: "bg-emerald-500/25 text-emerald-900 dark:bg-emerald-500/30 dark:text-emerald-300",
  ...
  sick: {
    ...
    chip: "bg-rose-500/25 text-rose-900 dark:bg-rose-500/30 dark:text-rose-300",
  ...
  standby: {
    ...
    chip: "bg-amber-500/25 text-amber-900 dark:bg-amber-500/30 dark:text-amber-300",
  ...
  holiday: {
    ...
    chip: "bg-sky-500/25 text-sky-900 dark:bg-sky-500/30 dark:text-sky-300",
...
export const calendarEventStatusStyles: Record<CalendarEvent["status"], CalendarTone> = {
  pending: {
    ...
    chip: "bg-orange-500/25 text-orange-900 dark:bg-orange-500/30 dark:text-orange-300",
